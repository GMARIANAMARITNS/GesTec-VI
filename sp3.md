...
|-----|-----------------------------------------------------------------------------|------------|------------|
| 1 | Como Secretário de Comércio Exterior, quero dispor de indicadores gerenciais para apoiar a tomada de decisões baseada em dados sobre as exportações brasileiras.        | Média     |2 pontos   |
